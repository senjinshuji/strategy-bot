...
exports.aiProviders = exports.ClaudeProvider = exports.OllamaProvider = exports.MockProvider = void 0;
...
class ClaudeProvider {
    constructor() {
        this.name = 'Claude 3.5 Haiku';
        this.cost = '約1.5円/回';
    }
    async analyze(data) {
        // 既存のClaude実装を使用
        const { analyzeMarketingStrategy } = await Promise.resolve().then(() => require('./anthropic'));
